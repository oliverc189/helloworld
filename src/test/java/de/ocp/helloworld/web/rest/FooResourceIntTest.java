...
import de.ocp.helloworld.domain.Foo;
import de.ocp.helloworld.repository.FooRepository;
...
import static de.ocp.helloworld.web.rest.TestUtil.createFormattingConversionService;
...
public class FooResourceIntTest extends AbstractCassandraTest {
    ...
    public void createFoo() throws Exception {
        ...
        assertThat(testFoo.getMessage()).isEqualTo(DEFAULT_MESSAGE);
    }
    ...
    public void updateFoo() throws Exception {
        ...
        Foo testFoo = fooList.get(fooList.size() - 1);
        assertThat(testFoo.getMessage()).isEqualTo(UPDATED_MESSAGE);
    }
